const ReactivateMail = (user, token) => {
    return {
      to: user?.email,
          ...
          >
            ...
            <div style="padding: 20px">
              ...
              <p style="font-size: 13px; color: gray">
                This email confirms that your ${process.env.NAME} account has been Reactivated as
                per your request. We are glad to see you back.
              </p>
