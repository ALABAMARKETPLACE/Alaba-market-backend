...
const ResetMailHtml = async (Details: any) => {
  try {
    let obj = {
      to: Details?.email,
          ...
          >
            ...
            <div style="padding: 20px">
              ...
              <p style="font-size: 13px; color: gray">
                You have successfully changed the email address for your ${process.env.NAME}
                account with username ${Details?.username}. You will get updations 
                and notifications to this email id henceforth. Login to ${process.env.NAME}.com 
                and verify your new email ID.
              </p>
              <p>Cheers,</p>
