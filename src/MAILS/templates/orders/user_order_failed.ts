...
const ToUserOrderFailed = async ({
  ...
  try {
    ...
    let obj = {
      to: user?.email,
      subject: `Your ${process.env.NAME} Order Failed.`,
      ...
      >
          ...
          <div style="text-align: justify; padding: 0 30px">
            ...
            <p>
              ...
              <br/>
                ...
                <br/>
                If you
              would like to see more info of your order or make any changes to it,
              please visit Your Orders on ${process.env.WEBSITE}.
            </p>
          </div>
          <div
            style="
        ...
        2
              ...
              <tr>
                <td>TAX:</td>
                <td>${process.env.CURRENCY} ${Number(newOrder?.tax)?.toFixed(2)}</td>
              </tr>
              <tr>
